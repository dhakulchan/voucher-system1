...
<body>
    ...
    def _get_css_styles(self) -> str:
        ...
        .running-header .company-info-mini {
            flex: 1;
        ...
        .running-header .company-name-mini {
            font-size: 16px; /* Same as main header */
            font-weight: 700;
            margin: 0 0 8px 0; /* Same as main header */
            color: #000;
            line-height: 1.2;
        }
        
        .running-header .company-details-mini {
            margin: 2px 0; /* Same as main header */
            font-size: 11px; /* Same as main header */
            line-height: 1.3;
        }
        
        .running-header .logo-section-mini {
            flex: 0 0 auto;
            margin-left: 20px;
            height: 80px; /* Match main header height */
            display: flex;
        ...
        .running-header .company-logo-mini {
            width: 92px; /* Same as main header */
            height: 69px; /* Same as main header */
            object-fit: contain;
        }
        
        .page-header {
            height: 80px; /* Same height as main header */
            display: flex;
        ...
        .page-header .company-details-mini {
            margin: 2px 0; /* Same as main header */
            font-size: 11px; /* Same as main header */
            line-height: 1.3;
        }
        
        .page-header .logo-section-mini {
            flex: 0 0 auto;
            margin-left: 20px;
            height: 80px; /* Match main header height */
            display: flex;
