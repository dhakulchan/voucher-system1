    ...
    def generate_quote_pdf(self, quote, booking, customer):
        ...
        try:
            ...
            def header_footer_on_page(canvas, doc):
                ...
                # Header - Logo left, Company info center, Quote right
                try:
                    # Logo on the left
                    ...
                    if os.path.exists(logo_path):
                        ...
                        canvas.drawImage(logo_reader, 15*mm, A4[1] - 25*mm, width=25*mm, height=12*mm, mask='auto')
                    
                    # Company info in the center-left
                    canvas.setFont('Helvetica-Bold', 9)  # Reduced from 11 to 9
                    canvas.setFillColor(colors.Color(44/255, 62/255, 80/255))  # #2C3E50
                    canvas.drawString(45*mm, A4[1] - 15*mm, "DHAKUL CHAN TRAVEL SERVICE (THAILAND) CO.,LTD.")
                    
                    # Contact info below company name
                    canvas.setFont('Helvetica', 8)
                    canvas.setFillColor(colors.Color(127/255, 140/255, 141/255))  # #7F8C8D
                    canvas.drawString(45*mm, A4[1] - 19*mm, "710, 716, 704, 706 Prachauthit Road, Samseenook, Huai Kwang, Bangkok 10310")
                    canvas.drawString(45*mm, A4[1] - 23*mm, "Tel: +662 2744218 | +662 0266525 Fax: +662 0266525 Press 5 | Line: @dhakulchan")
                    
                    canvas.setFont('Helvetica', 8)
                    canvas.setFillColor(colors.Color(52/255, 152/255, 219/255))  # #3498DB
                    canvas.drawString(45*mm, A4[1] - 27*mm, "Website: www.dhakulchan.net | T.A.T License 11/03659")
                    
                    # QUOTE label on the right
                    canvas.setFont('Helvetica-Bold', 24)
                    canvas.setFillColor(colors.Color(0, 102/255, 204/255))  # #0066cc
                    canvas.drawString(165*mm, A4[1] - 18*mm, "QUOTE")
